...
from keras.layers import LSTM, GRU, Conv1D, GlobalAveragePooling1D, MaxPooling1D, TimeDistributed
...
acc = accuracy_score(true_y,predicted.round(), normalize=True, sample_weight=None)
print acc
fscores = precision_recall_fscore_support(true_y,predicted.round(),average='macro')
print fscores 


# both accuracy calculated by evaluate() and sklearn accuracy_score()
# are same , it just rounds off keras predicitons 
